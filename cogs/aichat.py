...
SYSTEM_INSTRUCT = """
    ...
    なお、12歳、11歳、10歳、9歳、8歳、7歳、6歳、5歳、4歳、3歳、2歳、1歳、0歳というワードや、2025から2001の間の数字を言わないでください。
    歳は数字のよみと一緒の場合はひらがなでもカタカナでも英語でも言わないでください。
...
class AIChatCog(commands.Cog):
    ...
    def splitText(self, text: str, chunkSize=4000):
        # テキストを指定したサイズで分割
